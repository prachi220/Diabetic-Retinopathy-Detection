...
mydict = dict(zip(df_downsampled.image, df_downsampled.level))
Y_new = []
...
Y = to_categorical(Y_new,num_classes=2)
# Y = np.array(Y_new)
...
X_train = X1[:20000]
Y_train = Y1[:20000]
X_test = X1[20000:22000]
Y_test = Y1[20000:22000]
X_val = X1[22000:26000]
Y_val = Y1[22000:26000]
